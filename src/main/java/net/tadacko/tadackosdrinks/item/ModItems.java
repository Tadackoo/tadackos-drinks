...
public class ModItems {
    ...
    public static final RegistryObject<Item> SUGAR_CANE_CRUSHED = ITEMS.register("sugar_cane_crushed",
            () -> new Item(new Item.Properties()));
    public static int stackSizeMolasses = 16; // fallback default, overridden by config value
    public static final RegistryObject<Item> MOLASSES_SUGARCANE = ITEMS.register("molasses_sugarcane",
            () -> new Item(new Item.Properties()) { @Override public int getMaxStackSize(ItemStack stack) { return stackSizeMolasses; } });
    ...
    public static int stackSizeKeg = 1; // fallback default, overridden by config value
    public static final RegistryObject<Item> KEG = ITEMS.register("keg",
            () -> new KegItem(new Item.Properties()) { @Override public int getMaxStackSize(ItemStack stack) { return stackSizeKeg; } });

    public static int stackSizeGlass = 16; // fallback default, overridden by config value
    public static final RegistryObject<Item> BEER_GLASS_EMPTY = ITEMS.register("beer_glass_empty",
            ...
            { @Override public int getMaxStackSize(ItemStack stack) { return stackSizeGlass; } });
    ...
    public static int stackSizeDrink = 1; // fallback default, overridden by config value
